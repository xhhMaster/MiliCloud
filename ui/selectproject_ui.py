...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.projectList = QtGui.QTableWidget(self.projectGroupBox)
        self.projectList.setGeometry(QtCore.QRect(10, 30, 341, 391))
        self.projectList.verticalHeader().setVisible(False)
        self.projectList.horizontalHeader().setVisible(False)
        self.projectList.setSelectionMode(QtGui.QAbstractItemView.SingleSelection)
        self.projectList.setShowGrid(False)
        ...
        self.projectList.setColumnCount(0)
        self.projectList.setRowCount(0)
